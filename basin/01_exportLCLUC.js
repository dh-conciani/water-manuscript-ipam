...
var irrigation = ee.Image('projects/mapbiomas-workspace/public/collection8/mapbiomas_collection80_integration_v1');

// read territories
var territory = ee.FeatureCollection('users/dh-conciani/vectors/bacias_otto_n4')
  // create numerical ids
  .map(function(feature) {
    return (feature.set({'geocode': ee.Number.parse(feature.get('wts_pk'))}));
  });
